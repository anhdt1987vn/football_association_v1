...
var ALGORITHM = "HS256";
var ISSUER = "freeman@1987";
var AUDIENCE = "freeman@1987";
...
function _onLocalStrategyAuth(email, password, next) {
    console.log("#passport.js_onLocalStrategyAuth");
...
function _onJwtStrategyAuth(payload, next) {
    console.log("#passport.js_onJwtStrategyAuth");
    var user = payload.user;
    console.log("#passport.js_onJwtStrategyAuth " + user['email']);
    return next(null, user, {"code": "OK"});
}
